...
function ProductsScreen(props){
 ...
 const {loading:loadingSave,success:succeesSave,error:errorSave}=productSave;
 const productDelete= useSelector(state=>state.productDelete);
 const {loading:loadingDelete,success:succeesDelete,error:errorDelete}=productDelete;
